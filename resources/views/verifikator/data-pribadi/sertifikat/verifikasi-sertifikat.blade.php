...
<div class="card">
  <h5 class="card-header">Data Pencapaian</h5>
    <form
      ...
      method="POST"
      action="/verifikator/data-pribadi/sertifikat/{{ $sertifikat_user->id }}/edit"
    >
    @csrf
      @method('PUT')
        ...
        <div class="row">
            ...
            <div class="mb-3">
                ...
                <input
                  ...
                  value="{{ old('nama_pelatihan', $sertifikat_user->nama_pelatihan) }}"
                  disabled
                />
              </div>
              {{-- I.6 Kolom C --}}
              <div class="mb-3 col-md-6">
                ...
                <input
                  ...
                  value="{{ old('penyelenggara', $sertifikat_user->penyelenggara) }}"
                  disabled
                />
              </div>
              {{-- I.6 Kolom D --}}
              <div class="mb-3 col-md-6">
                ...
                <input
                  ...
                  name="lokasi"
                  placeholder="Lokasi"
                  value="{{ old('lokasi', $sertifikat_user->lokasi) }}"
                  disabled
                />
              </div>
              {{-- I.6 Kolom E --}}
              <div class="mb-3 col-md-6">
                ...
                <input
                  ...
                  name="negara"
                  placeholder="Negara"
                  value="{{ old('negara', $sertifikat_user->negara) }}"
                  disabled
                />
              </div>
              {{-- I.6 Kolom F --}}
              <div class="mb-3 col-md-6">
                ...
                <input
                  ...
                  value="{{ old('bulan_tahun', $sertifikat_user->bulan_tahun) }}"
                  disabled
                />
              </div>
          {{-- I.6 Kolom G --}}
            ...
            <select
              ...
              disabled
            >
            <option value="dasar" {{ old('tingkat_materi', $sertifikat_user->tingkat_materi) == "dasar" ? ' selected' : '' }}>
              Tingkat Dasar (Fundamental)
            </option>
            <option value="lanjut" {{ old('tingkat_materi', $sertifikat_user->tingkat_materi) == "lanjut" ? ' selected' : '' }}>
          ...
          <div class="mb-3 col-md-6">
            ...
            <select
              ...
              disabled
            >
            <option value="sampai-dengan-36" {{ old('jumlah_jam', $sertifikat_user->jumlah_jam) == "sampai-dengan-36" ? ' selected' : '' }}>
              Lama Pendidikan s/d 36 Jam
            </option>
            <option value="36-100" {{ old('jumlah_jam', $sertifikat_user->jumlah_jam) == "36-100" ? ' selected' : '' }}>
              Lama Pendidikan 36 - 100 Jam
            </option>
            <option value="100-240" {{ old('jumlah_jam', $sertifikat_user->jumlah_jam) == "100-240" ? ' selected' : '' }}>
              Lama Pendidikan 100 - 240 Jam
            </option>
            <option value="lebih-dari-240" {{ old('jumlah_jam', $sertifikat_user->jumlah_jam) == "lebih-dari-240" ? ' selected' : '' }}>
          ...
          <div class="mb-3">
            ...
            <textarea
              ...
              disabled rows="5"
            >{{ old('uraian', $sertifikat_user->uraian) }}</textarea>
          </div>
          <div class="mb-3">
      ...
      <div class="card-body">
        <div class="mb-3 col-md-12">
          ...
          >
            <option value="" {{ old('status_validasi', $sertifikat_user->status_validasi) == "" ? ' selected' : '' }} class="text-warning fw-bold">
              PENDING (*Pilih Hasil Validasi Anda Terhadap Pencapaian
              Mahasiswa)
            </option>
            <option value="invalid" {{ old('status_validasi', $sertifikat_user->status_validasi) == "invalid" ? ' selected' : '' }} class="text-danger fw-bold">
              INVALID (*Bila ada kesalahan pada pencapaian
              mahasiswa atau ada pencapaian yang tidak sesuai)
            </option>
            <option value="valid" {{ old('status_validasi', $sertifikat_user->status_validasi) == "valid" ? ' selected' : '' }} class="text-success fw-bold">
        ...
        <div class="mb-3 col-md-12">
          ...
          <textarea
            ...
            rows="5"
          >{{ old('catatan_verifikator', $sertifikat_user->catatan_verifikator) }}</textarea>
        </div>
