        ...
        <div class="row">
          ...
          <div class="mb-3 col-md-6">
            ...
            >
              ...
              <option value="daerah" {{ old('jenis_bahasa') == "daerah" ? ' selected' : '' }}>
                Bahasa Daerah
              </option>
              <option value="nasional" {{ old('jenis_bahasa') == "nasional" ? ' selected' : '' }}>
                Bahasa Nasional
              </option>
              <option value="asing-internasional" {{ old('jenis_bahasa') == "asing-internasional" ? ' selected' : '' }}>
          ...
          <div class="mb-3 col-md-6">
            ...
            >
              ...
              <option value="pasif" {{ old('kemampuan') == "pasif" ? ' selected' : '' }}>
                Pasif, Tertulis
              </option>
              <option value="aktif" {{ old('kemampuan') == "aktif" ? ' selected' : '' }}>
