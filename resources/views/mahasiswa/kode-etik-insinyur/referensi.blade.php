...
<div class="card">
    ...
    >
      ...
      <a href="{{ url('kode-etik-insinyur/referensi/tambah') }}" class="btn btn-primary mx-4 mt-2">Tambah Data</a>
    </div>
      ...
      <table class="table table-hover">
        ...
        <tbody>
          <tr>
            ...
            {{-- <td>
              <a
                href="/kode-etik-insinyur/referensi/detail"
                class="btn btn-sm btn-primary"
                >Detail</a
              >
            </td> --}}
            <td>
                <a href="{{ url('kode-etik-insinyur/referensi/detail') }}"
