...
<div class="card">
  <h5 class="card-header">Data Pencapaian</h5>
    <form
      ...
      method="POST"
      action="/kode-etik-insinyur/referensi/{{ $referensi_user->id }}"
    >
    @method('put')
      @csrf
      ...
      <div class="card-body">
        ...
        <div class="mb-3 col-md-12">
          ...
          <textarea
            ...
            rows="5"
          >{{ $referensi_user->catatan_verifikator }}</textarea>
        </div>
      </div>
      <hr class="my-0" />
        ...
        <div class="row">
          {{-- II.1 KOLOM B --}}
            ...
            <input
              ...
              name="nama_referensi"
              placeholder="Nama"
              value="{{  $referensi_user->nama_referensi }}"
              disabled
            />
          ...
          <div class="mb-3">
            ...
            <input
              ...
              placeholder="Alamat"
              value="{{ $referensi_user->alamat_referensi }}"
              disabled
            />
          ...
          <div class="mb-3 col-md-6">
            ...
            <input
              ...
              value="{{  $referensi_user->no_telp_referensi }}"
              disabled
            />
          ...
          <div class="mb-3 col-md-6">
            ...
            <input
              ...
              placeholder="Email"
              value="{{  $referensi_user->email_referensi }}"
              disabled
            />
