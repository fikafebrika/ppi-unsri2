...
<div class="card">
    ...
    @endif
    @if ($pengalaman_mengajar_users->count())
    <div class="table-responsive mx-3 mb-2 text-center">
      <table class="table table-hover">
        ...
        <tbody>
          @foreach ($pengalaman_mengajar_users as $pengalaman_mengajar_user)
          <tr>
            ...
            <td class="text-nowrap">
                ...
                ></a>
                <a href="/pengalaman-mengajar/{{ $pengalaman_mengajar_user->id }}/edit"
                ><i class="bx bx-edit-alt me-1" title="Edit"></i
                ></a>
                <form action="/pengalaman-mengajar/{{ $pengalaman_mengajar_user->id }}" method="post" class="d-inline">
                  @method('delete')
						      @csrf
