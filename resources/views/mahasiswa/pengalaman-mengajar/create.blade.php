        ...
        <div class="row">
          ...
          <div class="mb-3 col-md-6">
            ...
            >
              ...
              <option value="1-9" {{ old('periode') == "1-9" ? ' selected' : '' }}>
                1 - 9 Tahun
              </option>
              <option value="10-14" {{ old('periode') == "10-14" ? ' selected' : '' }}>
                10 - 14 Tahun
              </option>
              <option value="15-19" {{ old('periode') == "15-19" ? ' selected' : '' }}>
                15 - 19 Tahun
              </option>
              <option value="lebih-dari-20" {{ old('periode') == "lebih-dari-20" ? ' selected' : '' }}>
                > 20 Tahun
              </option>
          ...
          <div class="mb-3 col-md-6">
            ...
            >
              ...
              <option value="staf-pengajar" {{ old('jabatan') == "staf-pengajar" ? ' selected' : '' }}>
                Staf Pengajar
              </option>
              <option value="pimpinan" {{ old('jabatan') == "pimpinan" ? ' selected' : '' }}>
                Pimpinan
              </option>
            </select>
          </div>
          ...
          <div class="mb-3 col-md-6">
            ...
            >
              ...
              <option value="1-sks" {{ old('sks') == "1-sks" ? ' selected' : '' }}>
                1 SKS/ 15 Jam
              </option>
              <option value="2-3-sks" {{ old('sks') == "2-3-sks" ? ' selected' : '' }}>
                2 - 3 SKS/ 30 - 45 Jam
              </option>
              <option value="4-sks" {{ old('sks') == "4-sks" ? ' selected' : '' }}>
                4 SKS/ 60 Jam
              </option>
            </select>
          </div>
