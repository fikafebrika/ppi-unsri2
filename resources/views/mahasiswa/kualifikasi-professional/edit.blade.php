        ...
        <div class="row">
            ...
            <div class="mb-3 col-md-6">
                ...
                <input
                  ...
                  name="periode"
                  placeholder="Periode"
                  value="{{ old('periode', $kualifikasi_professional_user->periode) }}"
          ...
          <div class="mb-3 col-md-6">
            ...
            <input
              ...
              value="{{ old('pemberi_tugas', $kualifikasi_professional_user->pemberi_tugas) }}"
          ...
          <div class="mb-3">
            ...
            <input
              ...
              name="lokasi"
              placeholder="Lokasi"
              value="{{ old('lokasi', $kualifikasi_professional_user->lokasi) }}"
          ...
          <div class="mb-3 col-md-6">
            ...
            <input
              ...
              value="{{ old('nilai_proyek', $kualifikasi_professional_user->nilai_proyek) }}"
          ...
          <div class="mb-3 col-md-6">
            ...
            <input
              ...
              value="{{ old('nilai_tanggung_jawab', $kualifikasi_professional_user->nilai_tanggung_jawab) }}"
          ...
          <div class="mb-3">
            ...
            >{{ old('uraian', $kualifikasi_professional_user->uraian) }}</textarea>
            @error('uraian')
            <div class="invalid-feedback"> {{ $message }}</div>
            @enderror
          </div>
