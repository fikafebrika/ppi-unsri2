...
<div class="card">
  <h5 class="card-header">Data Pencapaian</h5>
    <form
      ...
      method="POST"
      action="/kualifikasi-profesional/{{ $kualifikasi_professional_user->id }}"
    ...
    @method('put')
      ...
      <div class="card-body">
        <div class="mb-3 col-md-12">
          ...
          >
          @if ($kualifikasi_professional_user->status_validasi === "valid")
          <option value="valid" class="text-success fw-bold" selected>
            VALID (*Bila semua pencapaian mahasiswa telah
            sesuai)
          </option>
          @elseif($kualifikasi_professional_user->status_validasi === "invalid")
          ...
          @elseif($kualifikasi_professional_user->status_validasi === "pending")
        ...
        <div class="mb-3 col-md-12">
          ...
          <textarea
            ...
            rows="5"
          >{{ $kualifikasi_professional_user->catatan_verifikator }}</textarea>
        </div>
      </div>
      <hr class="my-0" />
        ...
        <div class="row">
            <div class="mb-3 col-md-6">
                <label for="bukti_kualifikasi_profesional" class="form-label"
                  >Upload Bukti</label
                >
                <input type="hidden" name="oldBuktiKualifikasiProfesional" value="{{ $kualifikasi_professional_user->bukti_kualifikasi_profesional }}">
                @if ($kualifikasi_professional_user->bukti_kualifikasi_profesional)
                <iframe  id="pdf-preview" src="{{ asset('storage/' . $kualifikasi_professional_user->bukti_kualifikasi_profesional) }}" width="100%" height="500px"></iframe>
                @else
            ...
            <div class="mb-3 col-md-6">
                ...
                <input
                  ...
                  name="periode"
                  placeholder="Periode"
                  value="{{ $kualifikasi_professional_user->periode }}"
                  disabled
                />
                @error('periode')
                <div class="invalid-feedback"> {{ $message }}</div>
          ...
          {{-- III KOLOM C --}}
            ...
            <input
              ...
              value="{{  $kualifikasi_professional_user->nama_instansi }}"
              disabled
            />
            @error('nama_instansi')
            <div class="invalid-feedback"> {{ $message }}</div>
          ...
          <div class="mb-3 col-md-6">
            ...
            <input
              ...
              value="{{  $kualifikasi_professional_user->jabatan }}"
              disabled
            />
            @error('jabatan')
            <div class="invalid-feedback"> {{ $message }}</div>
          ...
          <div class="mb-3">
            ...
            <input
              ...
              value="{{  $kualifikasi_professional_user->nama_aktifitas }}"
              disabled
            />
          ...
          <div class="mb-3 col-md-6">
            ...
            <input
              ...
              value="{{  $kualifikasi_professional_user->pemberi_tugas }}"
              disabled
            />
            @error('pemberi_tugas')
            <div class="invalid-feedback"> {{ $message }}</div>
          ...
          <div class="mb-3">
            ...
            <input
              ...
              name="lokasi"
              placeholder="Lokasi"
              value="{{  $kualifikasi_professional_user->lokasi }}"
              disabled
            />
            @error('lokasi')
            <div class="invalid-feedback"> {{ $message }}</div>
          ...
          <div class="mb-3 col-md-6">
            ...
            >
              ...
              <option value="1-3" {{ old('durasi', $kualifikasi_professional_user->durasi) == "1-3" ? ' selected' : '' }}>
                1 - 3 Tahun
              </option>
              <option value="4-7" {{ old('durasi', $kualifikasi_professional_user->durasi) == "4-7" ? ' selected' : '' }}>
                4 - 7 Tahun
              </option>
              <option value="8-10" {{ old('durasi', $kualifikasi_professional_user->durasi) == "8-10" ? ' selected' : '' }}>
                8 - 10 Tahun
              </option>
              <option value="lebih-dari-10" {{ old('durasi', $kualifikasi_professional_user->durasi) == "lebih-dari-10" ? ' selected' : '' }}>
                10 Tahun
              </option>
          ...
          <div class="mb-3 col-md-6">
            ...
            >
              ...
              <option value="anggota" {{ old('posisi', $kualifikasi_professional_user->posisi) == "anggota" ? ' selected' : '' }}>
                Anggota/ Staff/ Dosen
              </option>
              <option value="supervisor" {{ old('posisi', $kualifikasi_professional_user->posisi) == "supervisor" ? ' selected' : '' }}>
                Supervisor/ Site Engineer/ Site Manager/
                KaLab/Sekretaris Jurusan/ Ketua Jurusan/ PD
              </option>
              <option value="direktur" {{ old('posisi', $kualifikasi_professional_user->posisi) == "direktur" ? ' selected' : '' }}>
                Direktur/ Ketua Tim/ Dekan/ PR/ Rektor
              </option>
              <option value="pengarah" {{ old('posisi', $kualifikasi_professional_user->posisi) == "pengarah" ? ' selected' : '' }}>
          ...
          <div class="mb-3 col-md-6">
            ...
            <input
              ...
              value="{{  $kualifikasi_professional_user->nilai_proyek }}"
              disabled
            />
            @error('nilai_proyek')
            <div class="invalid-feedback"> {{ $message }}</div>
          ...
          <div class="mb-3 col-md-6">
            ...
            <input
              ...
              value="{{  $kualifikasi_professional_user->nilai_tanggung_jawab }}"
              disabled
            />
          ...
          <div class="mb-3 col-md-6">
            ...
            >
              ...
              <option value="sedikit" {{ old('sdm_terlibat', $kualifikasi_professional_user->sdm_terlibat) == "sedikit" ? ' selected' : '' }}>
                Sedikit
              </option>
              <option value="sedang" {{ old('sdm_terlibat', $kualifikasi_professional_user->sdm_terlibat) == "sedang" ? ' selected' : '' }}>
                Sedang
              </option>
              <option value="banyak" {{ old('sdm_terlibat', $kualifikasi_professional_user->sdm_terlibat) == "banyak" ? ' selected' : '' }}>
                Banyak
              </option>
              <option value="sangat-banyak" {{ old('sdm_terlibat', $kualifikasi_professional_user->sdm_terlibat) == "sangat-banyak" ? ' selected' : '' }}>
                Sangat Banyak
              </option>
          ...
          <div class="mb-3 col-md-6">
            ...
            >
              ...
              <option value="rendah" {{ old('tingkat_kesulitan', $kualifikasi_professional_user->tingkat_kesulitan) == "rendah" ? ' selected' : '' }}>
                Rendah
              </option>
              <option value="sedang" {{ old('tingkat_kesulitan', $kualifikasi_professional_user->tingkat_kesulitan) == "sedang" ? ' selected' : '' }}>
                Sedang
              </option>
              <option value="tinggi" {{ old('tingkat_kesulitan', $kualifikasi_professional_user->tingkat_kesulitan) == "tinggi" ? ' selected' : '' }}>
                Tinggi
              </option>
              <option value="sangat-tinggi" {{ old('tingkat_kesulitan', $kualifikasi_professional_user->tingkat_kesulitan) == "sangat-tinggi" ? ' selected' : '' }}>
                Sangat tinggi
              </option>
          ...
          <div class="mb-3 col-md-6">
            ...
            >
              ...
              <option value="rendah" {{ old('skala_proyek', $kualifikasi_professional_user->skala_proyek) == "rendah" ? ' selected' : '' }}>
                Rendah
              </option>
              <option value="sedang" {{ old('skala_proyek', $kualifikasi_professional_user->skala_proyek) == "sedang" ? ' selected' : '' }}>
                Sedang
              </option>
              <option value="tinggi" {{ old('skala_proyek', $kualifikasi_professional_user->skala_proyek) == "tinggi" ? ' selected' : '' }}>
                Tinggi
              </option>
              <option value="sangat-tinggi" {{ old('skala_proyek', $kualifikasi_professional_user->skala_proyek) == "sangat-tinggi" ? ' selected' : '' }}>
                Sangat tinggi
              </option>
          ...
          <div class="mb-3">
            ...
            <textarea
              ...
              disabled
            >{{  $kualifikasi_professional_user->uraian }}</textarea>
            @error('uraian')
            <div class="invalid-feedback"> {{ $message }}</div>
            @enderror
          </div>
  ...
  <script>
    // Dapatkan elemen input file
        const pdfFileInput = document.getElementById('bukti_kualifikasi_profesional');
