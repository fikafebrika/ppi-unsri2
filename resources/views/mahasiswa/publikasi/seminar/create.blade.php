        ...
        <div class="row">
          ...
          <div class="mb-3 col-md-6">
            ...
            >
              ...
              <option value="nasional" {{ old('tingkatan_seminar') == "nasional" ? ' selected' : '' }}>
                Pada Seminar Nasional
              </option>
              <option value="internasional" {{ old('tingkatan_seminar') == "internasional" ? ' selected' : '' }}>
