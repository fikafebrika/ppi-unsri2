...
<div class="card">
  <h5 class="card-header">Data Pencapaian</h5>
    <form
      ...
      method="POST"
      action="/publikasi/karya-temuan/{{ $karya_temuan_user->id }}"
      ...
      <div class="card-body">
        ...
        <div class="mb-3 col-md-12">
          ...
          <textarea
            ...
            rows="5"
          >{{ $karya_temuan_user->catatan_verifikator }}</textarea>
        </div>
      </div>
      <hr class="my-0" />
        ...
        <div class="row">
            <div class="mb-3 col-md-6">
                <label for="bukti_karya_temuan" class="form-label"
                  >Upload Bukti</label
                >
                <input type="hidden" name="oldBuktiKaryaTemuan" value="{{ $karya_temuan_user->bukti_karya_temuan }}">
                @if ($karya_temuan_user->bukti_karya_temuan)
                <iframe  id="pdf-preview" src="{{ asset('storage/' . $karya_temuan_user->bukti_karya_temuan) }}" width="100%" height="500px"></iframe>
                @else
            ...
            <div class="mb-3 col-md-6">
                ...
                <input
                  ...
                  value="{{  $karya_temuan_user->bulan_tahun }}"
                  disabled
                />
                @error('bulan_tahun')
                <div class="invalid-feedback"> {{ $message }}</div>
          ...
          {{-- V.4 KOLOM C --}}
            ...
            <input
              ...
              value="{{  $karya_temuan_user->judul_karya_temuan }}"
              disabled
            />
          ...
          <div class="mb-3">
            ...
            <textarea
              ...
              disabled
            >{{  $karya_temuan_user->uraian }}</textarea>
            @error('uraian')
            <div class="invalid-feedback"> {{ $message }}</div>
            @enderror
          </div>
          ...
          <div class="mb-3 col-md-6">
            ...
            <input
              ...
              value="{{  $karya_temuan_user->nama_media }}"
              disabled
            />
            @error('nama_media')
            <div class="invalid-feedback"> {{ $message }}</div>
