        ...
        <div class="row">
            ...
            <div class="mb-3 col-md-6">
                ...
                <input
                  ...
                  value="{{  $makalah_user->bulan_tahun }}"
                  disabled
                />
                @error('bulan_tahun')
                <div class="invalid-feedback"> {{ $message }}</div>
          ...
          {{-- V.2 KOLOM C --}}
            ...
            <input
              ...
              value="{{  $makalah_user->judul_makalah }}"
              disabled
            />
            @error('judul_makalah')
            <div class="invalid-feedback"> {{ $message }}</div>
          ...
          <div class="mb-3 col-md-6">
            ...
            <input
              ...
              value="{{  $makalah_user->nama_makalah }}"
              disabled
            />
            @error('nama_makalah')
            <div class="invalid-feedback"> {{ $message }}</div>
          ...
          <div class="mb-3 col-md-6">
            ...
            <input
              ...
              value="{{  $makalah_user->penyelenggara }}"
              disabled
            />
            @error('penyelenggara')
            <div class="invalid-feedback"> {{ $message }}</div>
