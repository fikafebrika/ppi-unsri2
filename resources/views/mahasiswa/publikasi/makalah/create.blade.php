      ...
      <div class="card-body pb-3">
        <div class="row">
          ...
          <div class="mb-3 col-md-6">
            ...
            >
            <input
              class="form-control @error('nama_makalah') is-invalid @enderror"
              type="text"
              id="nama_makalah"
              name="nama_makalah"
              placeholder="Nama Seminar/ Lokakarya"
              value="{{ old('nama_makalah') }}"
          ...
          <div class="mb-3 col-md-6">
            ...
            >
              ...
              <option value="nasional" {{ old('tingkatan_makalah') == "nasional" ? ' selected' : '' }}>
                Pada Seminar Nasional
              </option>
              <option value="internasional" {{ old('tingkatan_makalah') == "internasional" ? ' selected' : '' }}>
