          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                  ...
                  ></a>
                  <a href="/data-pribadi/tanda-penghargaan/{{ $penghargaan_user->id }}/edit"
                  ><i class="bx bx-edit-alt me-1" title="Edit"></i
                  ></a>
                  <form action="/data-pribadi/tanda-penghargaan/{{ $penghargaan_user->id }}" method="post" class="d-inline">
                    @method('delete')
                    @csrf
