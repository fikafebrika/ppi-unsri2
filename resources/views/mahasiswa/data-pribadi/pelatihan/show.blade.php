        ...
        <div class="row">
            <div class="mb-3 col-md-6">
                <label for="bukti_pelatihan" class="form-label"
                  >Upload Bukti</label
                >
                <input type="hidden" name="oldbuktipelatihan" value="{{ $pelatihan_user->bukti_pelatihan }}" disabled>
            ...
            <div class="mb-3">
                ...
                <input
                  ...
                  value="{{  $pelatihan_user->nama_pendidikan }}"
                  disabled
                />
              ...
              <div class="mb-3 col-md-6">
                ...
                <input
                  ...
                  value="{{ $pelatihan_user->penyelenggara }}"
                  disabled
                />
                @error('penyelenggara')
                <div class="invalid-feedback"> {{ $message }}</div>
              ...
              <div class="mb-3 col-md-6">
                ...
                <input
                  ...
                  value="{{  $pelatihan_user->bulan_tahun }}"
                  disabled
                />
                @error('bulan_tahun')
                <div class="invalid-feedback"> {{ $message }}</div>
          ...
          {{-- I.5 Kolom G --}}
            ...
            >
              ...
              <option value="dasar" {{  $pelatihan_user->tingkat_materi == "dasar" ? ' selected' : '' }}>
                Tingkat Dasar (Fundamental)
              </option>
              <option value="lanjut" {{  $pelatihan_user->tingkat_materi == "lanjut" ? ' selected' : '' }}>
          ...
          <div class="mb-3 col-md-6">
            ...
            >
              ...
              <option value="sampai-dengan-36" {{  $pelatihan_user->jumlah_jam == "sampai-dengan-36" ? ' selected' : '' }}>
                Lama Pendidikan s/d 36 Jam
              </option>
              <option value="36-100" {{  $pelatihan_user->jumlah_jam == "36-100" ? ' selected' : '' }}>
                Lama Pendidikan 36 - 100 Jam
              </option>
              <option value="100-240" {{  $pelatihan_user->jumlah_jam == "100-240" ? ' selected' : '' }}>
                Lama Pendidikan 100 - 240 Jam
              </option>
              <option value="lebih-dari-240" {{  $pelatihan_user->jumlah_jam == "lebih-dari-240" ? ' selected' : '' }}>
          ...
          <div class="mb-3">
            ...
            <textarea
              ...
              placeholder="Uraian Singkat Materi Pendidikan/ Pelatihan, Tingkat Pendidikan, Sertifikat"
               rows="5"
            >{{  $pelatihan_user->uraian }}</textarea>
            @error('uraian')
            <div class="invalid-feedback"> {{ $message }}</div>
            @enderror
          </div>
