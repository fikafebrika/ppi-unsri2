...
<div class="card">
    ...
    >
      ...
      <a href="/data-pribadi/pelatihan/create" class="btn btn-primary text-nowrap mx-4 mt-2">Tambah Data</a>
    </div>
    ...
    <div class="alert alert-primary text-center fs-5 mx-4 mt-2" role="alert">
        Data Pelatihan Tidak Ada, Silakan <a href="/data-pribadi/pelatihan/create" class="fw-semibold text-decoration-underline">Tambah Data</a> Pelatihan
    </div>
    @endif
